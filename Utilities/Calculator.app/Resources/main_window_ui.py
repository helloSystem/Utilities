...
"color: \"#3f3f3f\";")
        ...
        self.stacked_widget.addWidget(self.basic)
        ...
        self.scientific_buttons_layout.setSpacing(3)
        self.scientific_buttons_layout.setObjectName("scientific_buttons_layout")
        self.verticalLayout_5.addLayout(self.scientific_buttons_layout)
        self.stacked_widget.addWidget(self.scientific)
