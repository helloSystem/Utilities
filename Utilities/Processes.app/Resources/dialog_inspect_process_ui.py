...
"        }")
        ...
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.tab_Environment)
        self.horizontalLayout_5.setContentsMargins(20, 30, 20, 20)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.treeViewEnvironment = QtWidgets.QTreeView(self.tab_Environment)
        self.treeViewEnvironment.setUniformRowHeights(True)
        self.treeViewEnvironment.setSortingEnabled(True)
        self.treeViewEnvironment.setObjectName("treeViewEnvironment")
        self.horizontalLayout_5.addWidget(self.treeViewEnvironment)
    ...
    def retranslateUi(self, InspectProcess):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Environment), _translate("InspectProcess", "Environment"))
