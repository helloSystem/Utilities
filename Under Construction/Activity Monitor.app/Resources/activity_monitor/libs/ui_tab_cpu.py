...
class Ui_TabCPU(object):
    def setupUi(self, TabCPU):
        ...
        self.gridLayout.addWidget(self.label_idle, 3, 0, 1, 1, QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.label_threads, 1, 3, 1, 1, QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.label_threads_value, 1, 4, 1, 1, QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.label_user, 1, 0, 1, 1, QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.label_system_value, 2, 1, 1, 1, QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.label_system, 2, 0, 1, 1, QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        self.widget_graph = CPUGraphBar(TabCPU)
        self.widget_graph.setObjectName("widget_graph")
        self.gridLayout.addWidget(self.widget_graph, 1, 6, 4, 1)
        ...
        self.gridLayout.addWidget(self.label_user_value, 1, 1, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout.addWidget(self.label_idle_value, 3, 1, 1, 1, QtCore.Qt.AlignRight)
