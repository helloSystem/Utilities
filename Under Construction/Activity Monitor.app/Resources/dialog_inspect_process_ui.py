...
"        }")
        ...
        self.gridLayout_4.addWidget(self.context_switches, 4, 0, 1, 1)
        self.cpu_time = QtWidgets.QLabel(self.tab)
        self.cpu_time.setObjectName("cpu_time")
        self.gridLayout_4.addWidget(self.cpu_time, 3, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.context_switches_value, 4, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.threads_number_value, 1, 1, 1, 1)
        self.ports = QtWidgets.QLabel(self.tab)
        self.ports.setObjectName("ports")
        self.gridLayout_4.addWidget(self.ports, 2, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.cpu_time_value, 3, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.file_descriptors_value, 5, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.status_value, 4, 1, 1, 1)
        self.mach_messages_out_value = QtWidgets.QLabel(self.tab)
        self.mach_messages_out_value.setMinimumSize(QtCore.QSize(20, 0))
        self.mach_messages_out_value.setText("")
        self.mach_messages_out_value.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.mach_messages_out_value.setObjectName("mach_messages_out_value")
        self.gridLayout_5.addWidget(self.mach_messages_out_value, 2, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.nice_value, 3, 1, 1, 1)
        self.status = QtWidgets.QLabel(self.tab)
        self.status.setObjectName("status")
        self.gridLayout_5.addWidget(self.status, 4, 0, 1, 1)
        self.mach_messages_out = QtWidgets.QLabel(self.tab)
        self.mach_messages_out.setObjectName("mach_messages_out")
        self.gridLayout_5.addWidget(self.mach_messages_out, 2, 0, 1, 1)
        self.mach_messages_in = QtWidgets.QLabel(self.tab)
        self.mach_messages_in.setObjectName("mach_messages_in")
        self.gridLayout_5.addWidget(self.mach_messages_in, 1, 0, 1, 1)
        self.mach_messages_in_value = QtWidgets.QLabel(self.tab)
        self.mach_messages_in_value.setMinimumSize(QtCore.QSize(20, 0))
        self.mach_messages_in_value.setText("")
        self.mach_messages_in_value.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.mach_messages_in_value.setObjectName("mach_messages_in_value")
        self.gridLayout_5.addWidget(self.mach_messages_in_value, 1, 1, 1, 1)
        self.nice = QtWidgets.QLabel(self.tab)
        self.nice.setObjectName("nice")
        self.gridLayout_5.addWidget(self.nice, 3, 0, 1, 1)
        spacerItem7 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_5.addItem(spacerItem7, 5, 0, 1, 1)
        self.handles = QtWidgets.QLabel(self.tab)
        self.handles.setObjectName("handles")
        self.gridLayout_5.addWidget(self.handles, 0, 0, 1, 1)
        self.handles_value = QtWidgets.QLabel(self.tab)
        self.handles_value.setMinimumSize(QtCore.QSize(20, 0))
        self.handles_value.setToolTip("")
        self.handles_value.setText("")
        self.handles_value.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.handles_value.setObjectName("handles_value")
        self.gridLayout_5.addWidget(self.handles_value, 0, 1, 1, 1)
    ...
    def retranslateUi(self, InspectProcess):
        ...
        self.cpu_time.setToolTip(_translate("InspectProcess", "<html><head/><body><p>The amount of memory devoted to executable code. </p></body></html>"))
        ...
        self.mach_messages_out.setToolTip(_translate("InspectProcess", "<html><head/><body><p>The memory used by shared libraries.</p></body></html>"))
        self.mach_messages_out.setText(_translate("InspectProcess", "Mach Messages Out:"))
        self.mach_messages_in.setToolTip(_translate("InspectProcess", "<html><head/><body><p> Memory that could be potentially shared with other processes.</p></body></html>"))
        self.mach_messages_in.setText(_translate("InspectProcess", "Mach Messages In:"))
        self.nice.setToolTip(_translate("InspectProcess", "<html><head/><body><p>The amount of memory shared with other processes, accounted in a way that the amount is divided evenly between the processes that share it. </p></body></html>"))
        self.nice.setText(_translate("InspectProcess", "Nice:"))
        self.handles.setToolTip(_translate("InspectProcess", "<html><head/><body><p>This is the memory which is unique to a process and which would be freed if the process was terminated right now.</p></body></html>"))
        self.handles.setText(_translate("InspectProcess", "Handles:"))
