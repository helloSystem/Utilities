...
"       ")
        ...
        self.dat_date_widget = QtWidgets.QDateEdit(self.DateAndTimeTab)
        font = QtGui.QFont()
        font.setFamily("Nimbus Sans")
        self.dat_date_widget.setFont(font)
        self.dat_date_widget.setObjectName("dat_date_widget")
        self.gridLayout_4.addWidget(self.dat_date_widget, 2, 0, 1, 1, QtCore.Qt.AlignHCenter)
